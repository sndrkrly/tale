    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ;
                email = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET).email;
            ...
            case 2:
                err_1 = _a.sent();
                console.log(err_1);
                return [2 /*return*/, res.status(401).json({ error: 'Sikertelen lekérés' })];
            case 3:
                ;
                return [2 /*return*/];
        }
